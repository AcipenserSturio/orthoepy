...
function fillDictionary() {
	dictionary = [
		...
		["бухга́лтеров", "бухгалтё́ров", "бухгалтеров"],
		["верна́", "ве́рна", "верна"],
		["вероиспове́дание", "вероисповеда́ние", "вероисповедание"],
		["взяла́", "взя́ла", "взяла"],
		["взяла́сь", "взя́лась", "взялась"],
		["включё́н", "вклю́чен", "включен"],
		["включё́нный", "вклю́ченный", "включенный"],
		...
		["довезё́нный", "до́везенный", "довезенный"],
		["до́верху", "дове́рху", "доверху"],
		["договорё́нность", "догово́ренность", "договоренность"],
		...
		["заселё́нный", "засе́ленный", "заселенный"],
		...
		["киоскё́р", "кио́скер", "киоскер"],
		["кла́ла", "клала́", "клала"],
		["кле́ить", "клеи́ть", "клеить"],
		["контролё́р", "контро́лер", "контролер"],
		...
		["низведё́н", "низве́ден", "низведен"],
		["низведё́нный", "низве́денный", "низведенный"],
		...
		["ободрё́н", "обо́дрен", "ободрен"],
		["ободрена́", "обо́дрена", "ободрена"],
		["ободрё́нный", "обо́дренный", "ободренный"],
		["ободри́ть", "обо́дрить", "ободрить"],
		["ободри́шься", "обо́дришься", "ободришься"],
		["обострё́нный", "обо́стренный", "обостренный"],
		...
		["определё́н", "опреде́лен", "определен"],
		...
		["отключё́нный", "отклю́ченный", "отключенный"],
		...
		["повторё́нный", "повто́ренный", "повторенный"],
		["повтори́т", "повто́рит", "повторит"],
		["поделё́нный", "поде́ленный", "поделенный"],
