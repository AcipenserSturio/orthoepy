export default [
  ...
  [
    ['пудреница', 'пудренница', 'пудре..ица'],
    ['труженик', 'труженник', 'труже..ик'],
    ['приданое', 'приданное', 'прида..ое'],
    ['гостиница', 'гостинница', 'гости..ица'],
    ['стеклянный', 'стекляный', 'стекля..ый'],
    ['деревянный', 'деревяный', 'деревя..ый'],
    ['оловянный', 'оловяный', 'оловя..ый'],
    ['ветреный', 'ветренный', 'ветре..ый'],
    ['венчанный', 'венчаный', 'венча..ый'],
    ['завещанный', 'завещаный', 'завеща..ый'],
    ['обещанный', 'обещаный', 'обеща..ый'],
    ['чванный', 'чваный', 'чва..ый'],
    ['казнённый', 'казнёный', 'казнё..ый'],
    ['рождённый', 'рождёный', 'рождё..ый'],
    ['неведанный', 'неведаный', 'неведа..ый'],
    ['невиданный', 'невиданый', 'невида..ый'],
    ['негаданный', 'негаданый', 'негада..ый'],
    ['нежеланный', 'нежеланый', 'нежела..ый'],
    ['нежданный', 'нежданый', 'нежда..ый'],
    ['долгожданный', 'долгожданый', 'долгожда..ый'],
    ['ненадёванный', 'ненадёваный', 'ненадёва..ый'],
    ['неожиданный', 'неожиданый', 'неожида..ый'],
    ['неслыханный', 'неслыханый', 'неслыха..ый'],
    ['нечаянный', 'нечаяный', 'нечая..ый'],
    ['деланный', 'деланый', 'дела..ый'],
    ['читанный', 'читаный', 'чита..ый'],
    ['недреманное око', 'недреманое око', 'недрема..ое око'],
    ['медленный', 'медленый', 'медле..ый'],
    ['священный', 'священый', 'свяще..ый'],
    ['Андрей Первозванный', 'Андрей Первозваный', 'Андрей Первозва..ый'],
    ['конченый человек', 'конченный человек', 'конче..ый человек'],
    ['названый брат', 'названный брат', 'назва..ый брат'],
    ['посажёный отец', 'посажённый отец', 'посажё..ый отец'],
    ['Прощёное воскресенье', 'Прощённое воскресенье', 'Прощё..ое воскресенье'],
    ['смышлёный', 'смышлённый', 'смышлё..ый'],
    ['контуженый', 'контуженный', 'контуже..ый'],
    ['только что контуженный', 'только что контуженый', 'только что контуже..ый'],
    ['раненый', 'раненный', 'ране..ый'],
    ['раненный в ногу', 'раненый в ногу', 'ране..ый в ногу'],
    ['крещёный', 'крещённый', 'крещё..ый'],
    ['крещённый летом', 'крещёный летом', 'крещё..ый летом'],
  ],
];
