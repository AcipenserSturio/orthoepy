        ...
        <div class="column">
          <div class="container">
            ...
            <div class="content has-text-justified">
              <p>
                Данный тренажёр предлагает в случайном порядке проблемные слова из
                одного из нижеприведённых списков, ваша цель - правильно назвать у
                слов ударение.
              </p>
              <p>
                После того, как вы один раз ответили на каждое слово в списке,
                тренажёр будет предлагать слова вновь, в этот раз приоритизируя те, в
                которых у вас были ошибки.
              </p>
              <p>
                Если вы хотите проверить произношение некоторого слова, не дожидаясь
                вопроса, вы можете навести курсор на это слово в столбце слева, и
                правильное произношение будет вам показано.
              </p>
              <p>
                Тренажёр заканчивает предлагать вопросы, если последний ваш ответ на
                каждое слово был правильным.
              </p>
            </div>
          </div>
        </div>
